...
export function rGQLQueryTreeMutation_SubtreeOperationFromJSON(object: any): RGQLQueryTreeMutation_SubtreeOperation {
  switch (object) {
    case 0:
...
export function rGQLQueryTreeMutation_SubtreeOperationToJSON(object: RGQLQueryTreeMutation_SubtreeOperation): string {
  switch (object) {
...
function createBaseRGQLPrimitive(): RGQLPrimitive {
  return { kind: 0, intValue: 0, floatValue: 0, stringValue: "", boolValue: false };
}
...
export const RGQLClientMessage = {
  ...
  fromJSON(object: any): RGQLClientMessage {
    return {
      ...
      mutateTree: isSet(object.mutateTree) ? RGQLQueryTreeMutation.fromJSON(object.mutateTree) : undefined,
      finishQuery: isSet(object.finishQuery) ? RGQLQueryFinish.fromJSON(object.finishQuery) : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RGQLClientMessage>, I>>(object: I): RGQLClientMessage {
    ...
    message.initQuery = (object.initQuery !== undefined && object.initQuery !== null)
      ...
      : undefined;
    message.mutateTree = (object.mutateTree !== undefined && object.mutateTree !== null)
      ? RGQLQueryTreeMutation.fromPartial(object.mutateTree)
      : undefined;
    message.finishQuery = (object.finishQuery !== undefined && object.finishQuery !== null)
...
export const RGQLQueryTreeMutation = {
  encode(message: RGQLQueryTreeMutation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.nodeMutation !== undefined && message.nodeMutation.length !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<RGQLQueryTreeMutation>, I>>(object: I): RGQLQueryTreeMutation {
    const message = createBaseRGQLQueryTreeMutation();
    message.queryId = object.queryId ?? 0;
    message.nodeMutation = object.nodeMutation?.map((e) => RGQLQueryTreeMutation_NodeMutation.fromPartial(e)) || [];
...
export const RGQLQueryTreeMutation_NodeMutation = {
  encode(message: RGQLQueryTreeMutation_NodeMutation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
function createBaseRGQLServerMessage(): RGQLServerMessage {
  return { queryError: undefined, valueInit: undefined, valueBatch: undefined, valueFinalize: undefined };
}
...
export const RGQLServerMessage = {
  ...
  fromJSON(object: any): RGQLServerMessage {
    return {
      ...
      valueFinalize: isSet(object.valueFinalize) ? RGQLValueFinalize.fromJSON(object.valueFinalize) : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RGQLServerMessage>, I>>(object: I): RGQLServerMessage {
    ...
    message.queryError = (object.queryError !== undefined && object.queryError !== null)
      ...
      : undefined;
    message.valueInit = (object.valueInit !== undefined && object.valueInit !== null)
      ? RGQLValueInit.fromPartial(object.valueInit)
      : undefined;
    message.valueBatch = (object.valueBatch !== undefined && object.valueBatch !== null)
      ? RGQLValueBatch.fromPartial(object.valueBatch)
      : undefined;
    message.valueFinalize = (object.valueFinalize !== undefined && object.valueFinalize !== null)
...
function createBaseRGQLValue(): RGQLValue {
  return { queryNodeId: 0, arrayIndex: 0, posIdentifier: 0, value: undefined, error: "" };
}
