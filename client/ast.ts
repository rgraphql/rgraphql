...
export function astValueToJs(node: ValueNode): PrimitiveValue {
  const sv: StringedValue = node as PrimitiveValue
  switch (node.kind) {
    case 'FloatValue':
    case 'IntValue':
      return +sv.value
...
export function validAstKinds(value?: PrimitiveValue): { [kind: string]: boolean } {
...
export function isAstKind(kind: string, value?: PrimitiveValue): boolean {
