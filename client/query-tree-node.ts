...
import { ArgsMap, ArgsToProto, CompareArgs, NewArgsMapFromAST } from './args-map.js'
import { VariableStore } from './var-store.js'
import { LookupASTType } from './type-lookup.js'
import { FieldNotFoundError, TypeNotFoundError } from './errors.js'
import { isAstPrimitive, unwrapAstType } from './ast.js'
import { RGQLQueryTreeNode } from '../rgraphql.pb.js'
...
export class QueryTreeNode {
  ...
  public buildProto(): RGQLQueryTreeNode {
    const children: RGQLQueryTreeNode[] = []
